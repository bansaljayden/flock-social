...
The hardware demo unit build plan (the maintainer's own notes, form factor locked
...
9. **The build plan and this code specify different hardware.** See "The build
   plan and this code do not agree". Needs the maintainer's decision before anything is
   ordered.
