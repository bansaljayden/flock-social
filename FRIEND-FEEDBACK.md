...
Verbatim requests from a friend testing the app, captured from the maintainer's
...
**Resolved by the maintainer: Kome is a restaurant name, not a typo.** The friend saw
...
Constraint that binds hard here: DESIGN-STANDARD rules forbid claiming features the
...
is cheap. 3 needs the maintainer to say which reading he meant. 5 is a copy task bound
