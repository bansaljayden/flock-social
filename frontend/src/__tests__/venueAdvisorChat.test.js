...
describe('Roost chat: design-standard pins on the source itself', () => {
  ...
  test('no em dash in any owner-visible string (DESIGN-STANDARD rule A2)', () => {
    // COMMENTS COME OUT FIRST, and that is the whole difference between this
    // test measuring the rule and measuring punctuation. DESIGN-STANDARD A2 bans
