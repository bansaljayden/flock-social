...
describe('the memory marker in the transcript', () => {
  ...
  test('none of the new Birdie copy carries an em dash (DESIGN-STANDARD A2/H18)', () => {
...
describe('the locked-forecast copy', () => {
  ...
  test('it promises nothing that does not exist', () => {
    // No price, no trial, no "unlimited", no "forever". DESIGN-STANDARD rule 5.
  ...
  test('no em dash, anywhere in the new copy (DESIGN-STANDARD A2/H18)', () => {
...
describe('the demo card renders the boundary', () => {
  ...
  test('the CTA under it is the only call to action', () => {
    // Restraint (DESIGN-STANDARD I): the section already has one button pointing at
