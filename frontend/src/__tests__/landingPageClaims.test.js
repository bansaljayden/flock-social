...
describe('the page only sells things that exist', () => {
  ...
  const claudeMd = fs.readFileSync(path.join(REPO, 'development setup', 'project documentation'), 'utf8');

  test('the "Not built" list in project documentation still names the two features this page used to sell', () => {
