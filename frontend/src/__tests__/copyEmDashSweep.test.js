...
//      about. DESIGN-STANDARD A2 counted these four itself and still rated the rule
...
describe('DESIGN-STANDARD A2: no em dash in any user-visible string in frontend/src', () => {
