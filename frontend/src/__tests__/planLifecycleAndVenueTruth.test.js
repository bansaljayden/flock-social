...
describe('a venue search that fails', () => {
  test('the eight invented venues are gone from the source entirely', () => {
    ...
    // away from being rendered again (DESIGN-STANDARD H13).
...
test('none of the copy this drop added carries an em dash', () => {
  // DESIGN-STANDARD A2/H18, the single most repeated regression in the repo. Scoped
  ...
  // whole-file count is famous for measuring the wrong thing (DESIGN-STANDARD A2:
