 ...
 *      is held at time zero. Same class DESIGN-STANDARD A10 bans scroll reveals for.
 *
...
describe('the entrance animation cannot ship the page blank', () => {
  ...
  test('nothing on these pages is a scroll-triggered reveal (DESIGN-STANDARD A10)', () => {
