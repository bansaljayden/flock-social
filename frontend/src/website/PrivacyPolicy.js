          ...
          <div className="pp-doc">
            ...
            <section id="venues">
              ...
              <p>
                ...
                are built from source distributions such as Google Places and from what Flock users
            ...
            <section id="deletion">
              ...
              <p>
                You can delete your account from inside the app (You &rarr; scroll to the bottom &rarr; Delete account)
              ...
              <ul>
                <li>Your account row and everything hanging off it: email, password hash, phone, year of birth (or the full date of birth on an older account), display name, avatar, bio, interests, payment handles, and your settings.</li>
            ...
            <section id="your-choices">
              ...
              <ul>
                <li><strong>Access, correction, export, deletion:</strong> you can export your data yourself in the app, under You (the last tab) and then Get a copy of my data, and it asks for your password first so that somebody holding your phone cannot lift it. For access or correction, or for the four things named below that the file leaves out, email {mail}. An export is a machine-readable copy of your account, your settings, your plans and calendar entries, the messages you sent, your votes, budgets, reactions, reviews, crowd reports, check-ins, bill-split shares, SOS records, friends, reports you filed, your trusted contacts, and your reliability score. Four things are not in that file today and we would rather say so than let you assume otherwise: the record of which crowd predictions we showed you, the list of accounts you have blocked, your registered push notification tokens, and your venue profile if you run a venue. Ask and we will send those too. The file itself also lists what it leaves out and why. You can delete your account yourself in the app (You &rarr; Delete account) or from our <a href="/delete-account">account deletion page</a>. To protect your account, deleting it asks you to confirm your password, or to sign in again if you use Apple or Google.</li>
