...
// TODO(the maintainer): swap for social at flockcorp.com once inbound mail is set up on
// the domain (Resend currently handles outbound only). A Gmail contact on a
// paid venue pitch reads as unprofessional (DESIGN-STANDARD.md B).
...
/* No scroll-reveal animation on this page, deliberately. Sections sliding in
   ...
   (DESIGN-STANDARD.md A10), and the content is better off just being there. */
