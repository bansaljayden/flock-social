...
// spinner (SLOP-AUDIT rule 10): the navy header, the moderation slot, the
...
// (SLOP-AUDIT A10 / H6). Content just is.
...
@keyframes tooltipFadeIn {
        ...
        * {
        ...
        /* The animated background-clip:text gradient that lived here is a
           banned pattern (project documentation, SLOP-AUDIT.md) and nothing in the
