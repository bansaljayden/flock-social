...
export default function VenueDashboard({
  ...
  verificationRequestNote,
    ...
    // whatsoever happens (DESIGN-STANDARD rule 5). The server's own wording is what
    ...
    //
    // The social mailbox, not the support one. DESIGN-STANDARD section B flagged
          ...
          <div style={{ marginTop: '12px', display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            >
              ...
              {/* A real spinner, not the bare "…" this overlay used to show —
                  ...
                  Small inline action, so a small inline spinner (DESIGN-STANDARD
          ...
          {venueTab === 'promotions' && can.postDeals && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              {/* The "Pro Tips" box was deleted 2026-08-14. It advised that
                  ...
                  (DESIGN-STANDARD §H13): invented numbers get cut, not softened.
          ...
          {venueTab === 'reviews' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              {/* WHY THE REPLY BUTTONS ARE NOT THERE.
                  ...
                  DESIGN-STANDARD H5 names, and it was one per review.
          ...
          {venueTab === 'settings' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              {/* The Notifications panel used to sit here: three switches, one
                  ...
                  DESIGN-STANDARD rule 5, no dead buttons, and the most expensive
