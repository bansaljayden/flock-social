...
const VenueInsightCards = ({ fetchCards, colors, intel, liveReading, operatingHours, onOpenSettings, now, verificationStatus, onRequestVerification }) => {
  ...
  // the maintainer's TestFlight note was that the screen said it too many times. The
  ...
  if (state === 'loading') {
    ...
    // shimmer App.js defines; DESIGN-STANDARD rule 10, skeletons for page loads).
    return (
