...
Please do not open a public GitHub issue for a security problem. That publishes the bug before it is fixed, which is the one thing deployment sourcerting exists to avoid.
