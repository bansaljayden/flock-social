...
The external code review adversarial review couldn't run (the ChatGPT account has no
code review model entitlement — auth works, the model allowlist is empty). This is the
