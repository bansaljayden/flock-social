...
// feature that was never built, which is the thing DESIGN-STANDARD rule 5 forbids:
...
router.post('/', requireVerified, [
  ...
  // quiet on that subject instead of guessing (DESIGN-STANDARD §C — never demand a
