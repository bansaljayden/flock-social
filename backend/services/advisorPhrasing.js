...
// wired up" is a dead button (DESIGN-STANDARD rule 5). Add the chip in the same
...
//   em dash     DESIGN-STANDARD rule 1, enforced structurally, not just prompted.
...
// only ever hold the verbs somebody thought of, and a code review walked past
...
// DESIGN-STANDARD rule 1 structurally. The em dash was the only one checked, so an
...
// for design-standard compliance (no em dashes); keep it complete when adding copy.
