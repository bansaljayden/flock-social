...
// the maintainer's decision (key dead, zero rows since 2026-05-18). The other is
...
// DESIGN-STANDARD.md rule 5 is "never claim what the shipping build cannot support",
