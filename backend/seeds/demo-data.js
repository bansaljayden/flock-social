...
async function seed() {
  ...
  try {
    ...
    const flockDefs = [
      ...
      {
        name: 'Birthday Dinner for the maintainer',
        creator: alex,
        venue_name: null,
        venue_address: null,
    ...
    // --- Birthday Dinner for the maintainer ---
    await msg('Birthday Dinner for the maintainer', alex, "ok team, the maintainer's birthday is next Saturday 🎂", 720);
    await msg('Birthday Dinner for the maintainer', mike, "we gotta make it special! any restaurant ideas?", 715);
    await msg('Birthday Dinner for the maintainer', emma, "what about that rooftop place? he mentioned wanting to go", 710);
    await msg('Birthday Dinner for the maintainer', jordan, "Rooftop @ The Grand? yes that's perfect", 705);
    await msg('Birthday Dinner for the maintainer', alex, "love it. I'll make a reservation. 7pm?", 700);
    await msg('Birthday Dinner for the maintainer', mike, "should we do a surprise or tell him?", 695);
    await msg('Birthday Dinner for the maintainer', emma, "surprise!! he'll love it", 690);
    await msg('Birthday Dinner for the maintainer', jordan, "my lips are sealed 🤐", 685);
    ...
    await rmsg('Gym Session', mike, "perfect, don't skip this time the maintainer 😂", 285);
