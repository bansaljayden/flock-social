...
test('the guards round 14 was not allowed to weaken are intact', () => {
  ...
  assert.equal(cols.length, 45,
    'the export contract is 45 columns: round 20 appended label_source and '
    + 'vendor_forecast_pct, round 25 appended events_observed; round 14 must not '
    + 'have added or dropped one');
