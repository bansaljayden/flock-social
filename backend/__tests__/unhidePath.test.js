...
test('COPY: every refusal this route can send passes the design rules', async () => {
...
const venueCtx = [/SELECT id, google_place_id, verified FROM venue_profiles/, () => ({
...
test('editing a hidden promotion is refused and the takedown is named', async () => {
  ...
  // DESIGN-STANDARD.md rule 1: no em dashes in user-visible copy.
