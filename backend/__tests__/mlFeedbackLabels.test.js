...
// to be the hardcoded 59751, which held right up until a run was killed: the
...
const PG_PORT = pickEmbeddedPgPort('mlFeedbackLabels');
...
test.before(async () => {
  ...
  pg = createEmbeddedPostgres(EmbeddedPostgres, {
    suite: 'mlFeedbackLabels', port: PG_PORT, databaseDir: dataDir,
  });
