...
function handle(text, params = []) {
  ...
  // deletion records, after the COMMIT. It is not a ban decision, so this
  // fixture models it and keeps nothing.
...
test('every new refusal message follows the copy standard', async () => {
  // DESIGN-STANDARD rule 1: no em dashes in user-visible text. These strings are all
