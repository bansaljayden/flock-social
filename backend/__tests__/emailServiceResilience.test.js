...
// part, and every link and word obeys DESIGN-STANDARD.md and the pinned production
// hosts.
// ===========================================================================
...
// ===========================================================================
// 5. Copy and link law (DESIGN-STANDARD.md + pinned production hosts)
// ===========================================================================
...
test('copy: no em dashes, no marketing cliches, in any subject or body', async () => {
  const banned = [
    /—/,                    // em dash — the first law in DESIGN-STANDARD.md
