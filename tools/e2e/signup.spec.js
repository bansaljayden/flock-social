...
test('the first screens carry no em dashes', async ({ page }) => {
  // DESIGN-STANDARD rule A2, and section H18 calls this the number one regression
...
test('Try again on the Discover banner answers the tap', async ({ page }) => {
  // Location is declined in this suite on purpose: DESIGN-STANDARD section K3 says
